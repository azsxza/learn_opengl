...
//	texture t2("awesomeface.png");
//
//	sd1.use();
//	sd1.setInt("texture1", 0);
//	sd1.setInt("texture2", 1);
//
//
...
//			model = glm::rotate(model, ((float)glfwGetTime()+i) * glm::radians(50.0f+i*5), glm::vec3(0.5f, 1.0f, 0.0f));
